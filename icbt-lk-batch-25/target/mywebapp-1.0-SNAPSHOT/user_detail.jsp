      ...
      <nav class="navbar navbar-expand-lg navbar-main nav-font">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav mr-auto nav-font">
            <li class="nav-item">
              <a class="nav-link nav-font" href="#">My Profile</a>
            </li>
            <li class="nav-item">
              <a class="nav-link nav-font" href="#">Customer</a>
            </li>
            <li class="nav-item">
              <a class="nav-link nav-font" href="verzen.html">Loan</a>
            </li>
            <li class="nav-item">
              <a class="nav-link nav-font" href="verzen.html">Products</a>
            </li>
            </ul>  
        </div>  
    </nav>
